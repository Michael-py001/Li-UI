	...
	export default {
		...
		computed: {
			...
			iconStyle() {
				...
				if (this.elActiveColor && this.modelValue && !this.isDisabled) {
			...
			iconColor() {
				return this.modelValue ? '#ffffff' : 'transparent';
			},
			iconClass() {
				let classes = [];
				classes.push('u-checkbox__icon-wrap--' + this.elShape);
				if (this.modelValue == true) classes.push('u-checkbox__icon-wrap--checked');
				if (this.isDisabled) classes.push('u-checkbox__icon-wrap--disabled');
				if (this.modelValue && this.isDisabled) classes.push('u-checkbox__icon-wrap--disabled--checked');
