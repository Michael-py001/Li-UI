<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" border-radius="24" :popup="false" v-model="modelValue" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
