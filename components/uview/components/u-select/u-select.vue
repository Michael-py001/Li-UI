...
<!-- 		<view class="u-select__action" :class="{
		...
		<u-popup :maskCloseAble="maskCloseAble" border-radius="24" mode="bottom" :popup="false" v-model="modelValue" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<view class="u-select">
